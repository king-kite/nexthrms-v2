...
import { useGetProjectEmployeesQuery } from '../../../store/features/projects-slice';
import {
	useAppSelector,
	useFormInput,
	useFormSelect,
...
interface InitErrorType
	extends Omit<TaskFormInitStateType, 'followers' | 'leaders'> {
	followers: string;
	leaders: string;
}
