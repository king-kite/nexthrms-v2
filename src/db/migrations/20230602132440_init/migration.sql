...
-- CreateEnum
CREATE TYPE "NotificationChoices" AS ENUM ('DOWNLOAD', 'ERROR', 'LEAVE', 'OVERTIME', 'SUCCESS');
...
-- CreateEnum
CREATE TYPE "PermissionModelChoices" AS ENUM ('assets', 'attendance', 'clients', 'departments', 'employees', 'groups', 'holiday', 'jobs', 'leaves', 'managed_files', 'overtime', 'permissions', 'permission_categories', 'projects', 'projects_files', 'projects_tasks', 'users');
...
CREATE TABLE "managed_files" (
    ...
    "url" TEXT NOT NULL DEFAULT '/images/default.png',
    "size" INTEGER,
    "storage_info" JSONB,
