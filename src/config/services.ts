...
export const NOTIFICATION_URL = (id: number | string) => `${ROOT_URL}/notifications/${id}/`;
...
export const ATTENDANCE_ADMIN_IMPORT_URL = `${ROOT_URL}/attendance/admin/import/`;
export const ATTENDANCE_ADMIN_SINGLE_URL = (id: string) => `${ROOT_URL}/attendance/admin/${id}/`;
...
export const LEAVE_ADMIN_URL = (id: string) => `${ROOT_URL}/leaves/admin/${id}/`;
...
export const OVERTIME_ADMIN_DETAIL_URL = (id: string) => `${ROOT_URL}/overtime/admin/${id}/`;
export const OVERTIME_ADMIN_EXPORT_URL = `${ROOT_URL}/overtime/admin/export/`;
export const OVERTIME_ADMIN_IMPORT_URL = `${ROOT_URL}/overtime/admin/import/`;
...
export const PROJECT_TEAM_URL = (id: string) => `${ROOT_URL}/projects/${id}/team/`;
export const PROJECT_TEAM_EXPORT_URL = (id: string) => `${ROOT_URL}/projects/${id}/team/export/`;
export const PROJECT_TEAM_IMPORT_URL = (id: string) => `${ROOT_URL}/projects/${id}/team/import/`;
export const PROJECT_TEAM_MEMBER_URL = (project_id: string, id: string) =>
	`${ROOT_URL}/projects/${project_id}/team/${id}/`;
export const PROJECT_FILES_URL = (id: string) => `${ROOT_URL}/projects/${id}/files/`;
export const PROJECT_FILES_EXPORT_URL = (id: string) => `${ROOT_URL}/projects/${id}/files/export/`;
export const PROJECT_FILES_IMPORT_URL = (id: string) => `${ROOT_URL}/projects/${id}/files/import/`;
...
export const OBJECT_PERMISSIONS_URL = (
	...
	if (groups)
		url += `&groupLimit=${groups.limit || ''}&groupOffset=${groups.offset || ''}&groupSearch=${
			groups.search || ''
		}`;
	if (users)
...
export const USER_PERMISSIONS_URL = (id: string) => `${USERS_URL}${id}/permissions/`;
